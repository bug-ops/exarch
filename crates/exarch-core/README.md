...
[![MSRV](https://img.shields.io/badge/MSRV-1.98.0-blue)](https://github.com/bug-ops/exarch)
...
> [!IMPORTANT]
> Requires Rust 1.98.0 or later (Edition 2024).
...
> [!NOTE]
> Minimum Supported Rust Version: **1.98.0**. MSRV increases are minor version bumps.
