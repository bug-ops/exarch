...
| NFR-010 | Compatibility | MSRV 1.98.0; no const generics or APIs introduced after 1.98 |
...
| SC-008 | MSRV compliance | `cargo check -p exarch-core --all-features` passes on Rust 1.98.0 |
